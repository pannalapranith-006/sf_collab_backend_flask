...
class Alert(db.Model):
    ...
    priority        = db.Column(db.Enum(AlertPriority), nullable=False, default=AlertPriority.LOW)
...
class WorkspaceAlertConfig(db.Model):
    ...
    id                 = db.Column(db.Integer, primary_key=True)
    workspace_id       = db.Column(db.Integer, nullable=False, unique=True)
    shift_start        = db.Column(db.Time, default=datetime.strptime('09:00', '%H:%M').time())
    attendance_cutoff  = db.Column(db.Time, default=datetime.strptime('10:00', '%H:%M').time())
    update_cutoff      = db.Column(db.Time, default=datetime.strptime('18:00', '%H:%M').time())
