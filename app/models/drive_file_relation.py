"""
app/models/drive_file_relation.py
"""
...
class DriveFileRelation(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint(
            "file_id", "relation_type", "related_entity_id",
    ...
    def __repr__(self):
        return (
            f"<DriveFileRelation file={self.file_id} "
            f"type={self.relation_type} entity={self.related_entity_id}>"
        )
