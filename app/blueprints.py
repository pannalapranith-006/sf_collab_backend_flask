from app.routes import ai_news_routes
...
# ── ERP & related module imports ──────────────────────────────────────────
from .routes.analytics_routes import analytics_bp
from .routes.activity_monitor_routes import activity_monitor_bp
from app.routes.ai_news_routes import ai_news_bp
from app.routes.meet_routes import meet_bp

# ── NEW ERP MODULES ──────────────────────────────────────────────────────
from app.routes.workspace_members_routes import workspace_members_bp
from app.routes.attendance_routes import attendance_bp
from app.routes.daily_update_routes import daily_update_bp
from app.routes.task_lifecycle_routes import task_lifecycle_bp
...
from app.routes.revenue_pool_routes import revenue_pool_bp
...
blueprints = [
    ...
    # ── Shared analytics & activity monitors (pre‑ERP) ──────────────────
    { "blueprint": analytics_bp,          "url_prefix": '/analytics' },
    { "blueprint": activity_monitor_bp,   "url_prefix": '/api/activity' },

    # ── AI news & meet (existing) ──────────────────────────────────────
    { "blueprint": ai_news_bp,            "url_prefix": '/api' },
    { "blueprint": meet_bp,               "url_prefix": '/api/meet' },

    # ── NEW ERP MODULES ────────────────────────────────────────────────
    { "blueprint": workspace_members_bp,  "url_prefix": '/api' },
    { "blueprint": attendance_bp,         "url_prefix": '/api' },
    { "blueprint": daily_update_bp,       "url_prefix": '/api' },
    { "blueprint": task_lifecycle_bp,     "url_prefix": '/api' },
    { "blueprint": proof_bp,              "url_prefix": '/api' },
    { "blueprint": monitoring_bp,         "url_prefix": '/api' },
    { "blueprint": points_bp,             "url_prefix": '/api' },
    { "blueprint": revenue_pool_bp,       "url_prefix": '/api' },
