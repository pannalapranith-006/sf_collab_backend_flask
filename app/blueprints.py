...
#  SF Drive Module
from .routes.drive_routes import drive_bp
from app.routes.drive_files_routes import drive_file_bp
from app.routes.drive_file_relation_routes import drive_file_relation_bp
from app.routes.drive_meetings_routes import drive_meetings_bp
...
blueprints = [
    ...
    {"blueprint": drive_file_bp, "url_prefix": "/api/drive/files"},
    {"blueprint": drive_file_relation_bp, "url_prefix": "/api/drive/file-relations"},
    {"blueprint": drive_meetings_bp, "url_prefix": "/api/drive/meetings"},
